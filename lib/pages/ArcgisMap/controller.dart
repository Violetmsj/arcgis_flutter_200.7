...
class ArcgisMapController extends GetxController {
  ArcgisMapController();
  ...
  Future<void> onMapViewReady() async {
    try {
      ...
      // 隐藏地图右下角的版权信息
      mapViewController.isAttributionTextVisible = false;
      mapViewController.arcGISMap = map;
      // 使用图形管理器添加图形
      final graphicsManager = GraphicsManager();
      graphicsManager.addAllGraphics();
      mapViewController.graphicsOverlays.add(graphicsManager.overlay);
      mapViewController.graphicsOverlays.add(drawPolygonGraphicsOverlay);
      mapViewController.graphicsOverlays.add(drawPolygonPointsOverlay);
      mapViewController.imageOverlays.add(imageOverlay);
